...
export function SikhTemplate({
  ...
  return (
    <div ref={containerRef} className="bg-[#FAF9F6] text-[#2D2926] overflow-x-hidden w-full min-h-screen">
      ...
      <section className="relative h-[100dvh] w-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity, y: heroTextY }} className="relative z-10 text-center px-6 max-w-5xl space-y-16">
          <div className="space-y-6">
            ...
            <p className="text-white font-sans text-[11px] uppercase tracking-editorial font-bold text-shadow-hero">Satnam Waheguru</p>
            <div className="w-24 h-px bg-[#E8D5A0] mx-auto" />
          </div>
          
          <h1 className="font-serif italic text-5xl md:text-[5.5rem] lg:text-[7rem] text-white font-normal leading-[1.0] kerning-loose text-shadow-hero">
            By His Divine Command, <br />
            <span className="opacity-95 italic text-[#FDFBF7]">Two Souls, One Light</span>
          </h1>

          <div className="space-y-8 pt-6">
            <h2 className="font-serif text-3xl md:text-[4rem] text-[#E8D5A0] kerning-loose font-medium text-shadow-hero tracking-tight">
      ...
      <section className="relative py-32 md:py-64 px-6 md:px-24 bg-[#F9F7F5]">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 md:gap-32 items-center">
          ...
          >
            ...
            <div className="space-y-8 font-sans text-sm md:text-base text-[#4A4A4A] font-light leading-relaxed tracking-wider opacity-85 max-w-lg">
      ...
      <section className="relative py-32 md:py-52 bg-[#002B49] text-[#FDFBF7] overflow-hidden">
            ...
            {invite.data.events.map((event, i) => (
              ...
              >
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="font-serif text-2xl md:text-3xl font-normal tracking-widest text-white">{event.title}</h3>
                </div>
